 ...
 * 功能： 对电机位置模式，使能电机，设置电机位置值，循环获取实际pvct
 * @author  xufuliang
 * @date    2025-10-15
 */
#include <stdio.h>
...
int main(int argc, char* argv[]) {
    ...
    //生成电机对象
    RobotMotor* motor = robot_create_motor(ctx, 8, 1);


    while (1) 
    {
        //设置电机电流模式
        value = robot_motor_set_control_mode(motor, MOTOR_CTRL_MODE_POSITION);
