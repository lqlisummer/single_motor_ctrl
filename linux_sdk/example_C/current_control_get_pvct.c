/*
 * current_control_get_pvct.c

 * 功能： 对电机设置电流模式，使能电机，设置电机电流值，循环获取实际pvct
 * @author  xufuliang
 * @date    2025-08-27
 */
#include <stdio.h>
...
int main(int argc, char* argv[]) {
    ...
    //生成电机对象
    RobotMotor* motor = robot_create_motor(ctx, 23, 2);
    ...
    {
        //设置电机电流模式
        value = robot_motor_set_control_mode(motor, MOTOR_CTRL_MODE_CURRENT);
